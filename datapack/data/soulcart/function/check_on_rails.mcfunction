...
execute if score @s SoulCartDirection matches 0..1 if block ~ ~ ~ #minecraft:rails[shape=east_west] run scoreboard players set @s SoulCartOnRails 1
execute if score @s SoulCartDirection matches 2..3 if block ~ ~ ~ #minecraft:rails[shape=north_south] run scoreboard players set @s SoulCartOnRails 1
