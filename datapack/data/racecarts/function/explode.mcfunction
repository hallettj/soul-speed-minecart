...
execute if score @s RacecartExploding matches 2 run summon creeper ~ ~ ~ {ExplosionRadius:1,ignited:1b,Fuse:0}
...
execute if score @s RacecartExploding matches 1 run damage @s 5 minecraft:explosion

scoreboard players remove @s RacecartExploding 1
